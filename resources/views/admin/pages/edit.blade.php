...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">Edit page about {{$page->title}}</h4>
        </div>
        <div class="col-sm-6">
                    ...
                    <div class="form-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>title</label>
                                <input type="text" name="title" value="{{$page->title}}" class="form-control @error('title') is-invalid @enderror" required>
                                @error('title')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="sub_title" value="{{$page->sub_title}}" class="form-control @error('sub_title') is-invalid @enderror" required>
                                @error('sub_title')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label>details</label>
                                <textarea name="details" class="form-control" id="details" rows="5">{!! $page->details !!}</textarea>
                                @error('details')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
