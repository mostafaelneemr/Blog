    ...
    <div class="row">
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <form class="form" action="{{route('slider-home.update', $sliders->id)}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf

                        <div class="form-group">
                            <div class="text-center">
                                <img src="{{asset($sliders->image_url)}}" class="rounded-circle h-25 w-25" alt="image slider">
                            </div>
                        </div>
