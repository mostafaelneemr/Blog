                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            {{-- @if (\App\Models\backend\home\slider::where('slider_type', 'home')->count() == 0) --}}
                                                <a href="{{route('slider-home.create')}}" class="btn btn-success" role="button" aria-pressed="true">create</a> 
                                            {{-- @endif --}}
                                        </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered p-0 text-center table-hover">
                                            ...
                                            @foreach($sliders as $slider)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('slider-home.edit',$slider->id)}}" class="btn btn-info btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
