                    ...
                    <div class="row">
                        <div class="col-md-12 mb-30">
                            <div class="card card-statistics h-100">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            {{-- @if (\App\Models\backend\home\slider::where('slider_type', 'home')->count() == 0) --}}
                                                <a href="{{route('slider-contact.create')}}" class="btn btn-success" role="button" aria-pressed="true">create</a> 
                                            {{-- @endif --}}
                                        </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered p-0 text-center table-hover">
                                            ...
                                            @foreach($sliders as $slider)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('slider-contact.edit',$slider->id)}}" class="btn btn-info btn-sm" title="Edit" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                ...
                                @include('admin.contact.slider.delete')
                            </div>
                        </div>
                    </div>
                </div>
