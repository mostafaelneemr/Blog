...
<html lang="en">
    <head>
        ...
        <style>
            .page-link {
                color: #00657b; text-align: center;
            }
            .page-item.active .page-link{
                background: #00657b; border-color: #00567b;
            }
            .category-list{
                padding: 0; margin: 0;
            }
                    ...
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        @php($pages = getPages())
                            @foreach($pages as $page)
                                <li class="nav-item">
                                    <a class="nav-link px-lg-3 py-3 py-lg-4" href="{{ url('page/' . $page->slug) }}">{{ $page->title }}</a>
                                </li>
                            @endforeach
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('contact.show')}}">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
